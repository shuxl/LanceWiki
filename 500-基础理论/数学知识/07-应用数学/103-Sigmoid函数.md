...
+ 知识点
	+ $\theta^T x$ ：[104-Sigmiod中的向量点积（内积）](../99-old/线性代数/104-Sigmiod中的向量点积（内积）.md)
	+ Sigmoid函数求导的公式： [106-Sigmoid 函数 求导](../07-应用数学/106-Sigmoid%20函数%20求导.md)
	+ 反向传播 [105-反向传播 的 理解](../06-数值计算/105-反向传播%20的%20理解.md)
