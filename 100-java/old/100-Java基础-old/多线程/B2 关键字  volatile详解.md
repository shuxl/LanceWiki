...
+ 个人理解
	+ 例子 [2.3.1 问题1： i++为什么不能保证原子性?](#2.3.1%20问题1：%20i++为什么不能保证原子性?) 可以结合 [A1 Java并发-理论基础](A1%20Java并发-理论基础.md) 的 原子性例子理解
		+ 个人猜测是因为，将更新后的值写回到缓冲这一步的操作，在多线程切换时，如果发生其它线程切换，可能会使当前线程的写入值是个旧值，从而造成数据问题
	+ volatile的应用场景需要多理解

# 1 带着BAT大厂的面试问题去理解volatile
- volatile关键字的作用是什么?
- volatile能保证原子性吗?
...
### 2.3.2 问题2： 共享的long和double变量的为什么要用volatile?
...
### 3.2.1 volatile 的 happens-before 关系
...
![](img/Pasted%20image%2020240716210509.png)

因为以上规则，当线程 A 将 volatile 变量 flag 更改为 true 后，线程 B 能够迅速感知。

### 3.2.2 volatile 禁止重排序
...
![](img/Pasted%20image%2020240716210636.png)
...
![](img/Pasted%20image%2020240716210553.png)

![](img/Pasted%20image%2020240716211356.png)
...
## 4.2 模式2：一次性安全发布(one-time safe publication)
...
## 4.3 模式3：独立观察(independent observation)
