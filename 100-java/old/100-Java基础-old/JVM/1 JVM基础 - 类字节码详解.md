+ jvm上运行的语言除了java，还可以是其它语言
+ 有趣的知识：.class以cafe babe开头的四个字节文件
+ 可能需要注意的知识：class文件有哪些内容，这里我记不住
+ 知识来源 [JVM基础-类字节码详解](https://pdai.tech/md/java/jvm/java-jvm-class.html)
...
![](img/Pasted%20image%2020240712201553.png)
