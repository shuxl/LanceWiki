+ 线程的基本类型变量和引用类型变量存储的位置不同
	+ 基本类型存储在线程栈上
	+ 引用类型存储在公共的堆上
+ java 的synchronized块和volatile关键字为何被引入
...
![](img/Pasted%20image%2020240715145733.png)
...
![](img/Pasted%20image%2020240715145954.png)
...
![](img/Pasted%20image%2020240715150406.png)
...
这是现代计算机硬件架构的简化图：
![](img/Pasted%20image%2020240715152431.png)
...
![](img/Pasted%20image%2020240715152703.png)
...
![](img/Pasted%20image%2020240715152909.png)
...
![](img/Pasted%20image%2020240715152959.png)
