...
![](img/Pasted%20image%2020240806203220.png)
...
![](img/Pasted%20image%2020240806203230.png)

## 3.2 ASK 重定向

Ask重定向发生于集群伸缩时，集群伸缩会导致槽迁移，当我们去源节点访问时，此时数据已经可能已经迁移到了目标节点，使用Ask重定向来解决此种情况。

https://pdai.tech/images/db/redis/redis-cluster-5.png
...
- 循环上述过程，直到最终加入集群
![](img/Pasted%20image%2020240806203429.png)
...
- 超过半数后变成新Master
- 广播Pong通知其他集群节点
![](img/Pasted%20image%2020240806203513.png)
...
![](img/Pasted%20image%2020240806203553.png)
...
![](img/Pasted%20image%2020240806203608.png)
...
![](img/Pasted%20image%2020240806203625.png)
