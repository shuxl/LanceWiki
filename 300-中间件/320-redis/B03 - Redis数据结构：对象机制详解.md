...
我们在前文已经阐述了[B02 - Redis的数据类型](B02%20-%20Redis的数据类型.md)；那么这些基础类型的底层是如何实现的呢？

带着这个问题我们来着手理解底层设计，首先看下图：
![](img/Pasted%20image%2020240805161917.png)
...
![](img/Pasted%20image%2020240805162201.png)
...
![](img/Pasted%20image%2020240805162232.png)
...
比如现在执行LPOP命令：
![](img/Pasted%20image%2020240805162314.png)
...
![](img/Pasted%20image%2020240805162403.png)
