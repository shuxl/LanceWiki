+ Redis事务的本质其实是，保障事务内的多个命令**连续**执行，**不被**事务外命令**插队**
+ 但是：
	+ 命令错误，会继续执行
	+ 不会滚
	+ 执行
...
![](img/Pasted%20image%2020240806102042.png)
...
![](img/Pasted%20image%2020240806102100.png)
...
著作权归@pdai所有 原文链接：https://pdai.tech/md/db/nosql-redis/db-redis-x-trans.html