...
具体可以参看：[线程安全的实现方法](A1%20Java并发-理论基础.md#6%20线程安全的实现方法)，这里我们将对CAS重点阐释。
...
![](img/Pasted%20image%2020240718154535.png)
...
# 6 再讲讲AtomicStampedReference解决CAS的ABA问题

## 6.1 AtomicStampedReference解决ABA问题
