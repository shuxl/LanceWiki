...
正式学习时先了解五个部分：
![](img/Pasted%20image%2020240718101923.png)
...
![](img/Pasted%20image%2020240718102037.png)
...
## 3.6 抽象类(long): AbstractQueuedLongSynchronizer
...
## 3.7 核心抽象类(int): AbstractQueuedSynchronizer
...
## 4.11 List: CopyOnWriteArrayList
...
## 4.15 Map: ConcurrentSkipListMap
...
## 5.1 基础类型：AtomicBoolean，AtomicInteger，AtomicLong

> AtomicBoolean，AtomicInteger，AtomicLong是类似的，分别针对bool，interger，long的原子类。

## 5.2 数组：AtomicIntegerArray，AtomicLongArray，BooleanArray

> AtomicIntegerArray，AtomicLongArray，AtomicBooleanArray是数组原子类。

## 5.3 引用：AtomicReference，AtomicMarkedReference，AtomicStampedReference

> AtomicReference，AtomicMarkedReference，AtomicStampedReference是引用相关的原子类。

## 5.4 FieldUpdater：AtomicLongFieldUpdater，AtomicIntegerFieldUpdater，AtomicReferenceFieldUpdater
...
![](img/Pasted%20image%2020240718152701.png)
...
## 6.8 核心: ScheduledThreadExecutor
