+ 为什么需要持久化：1、Redis本身是内存数据库，重启后数据会丢失；2、若不持久化，外部服务需要重建数据，代价高昂
+ Redis持久化有两种方案：RDB、AOF
	+ RDB 全量备份（内存快照）
	+ AOF 命令式、增量命令
+ 两种方案混用更好，4.0版本
# 1 Redis持久化简介
...
bgsave流程图如下所示
![](img/Pasted%20image%2020240806092615.png)
...
![](img/Pasted%20image%2020240806092943.png)
...
![](img/Pasted%20image%2020240806093053.png)
...
![](img/Pasted%20image%2020240806093218.png)
...
![](img/Pasted%20image%2020240806093408.png)
...
![](img/Pasted%20image%2020240806093539.png)
...
![](img/Pasted%20image%2020240806093647.png)
...
![](img/Pasted%20image%2020240806093728.png)
...
![](img/Pasted%20image%2020240806093809.png)
...
![](img/Pasted%20image%2020240806093824.png)
