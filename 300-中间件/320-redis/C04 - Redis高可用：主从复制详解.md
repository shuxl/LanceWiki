...
+ 持久化功能如果关闭了，对主从复制的影响：
	+ 自动重启功能不要启用
+ 主从复制的模式，优化方式是：一主、一丛、多从，来减少主从复制的资源消耗
+ 在主从上进行读写分离可能会遇到的问题：
	1. **延迟与不一致问题**
# 1 主从复制概述
...
![](img/Pasted%20image%2020240806120609.png)
...
![](img/Pasted%20image%2020240806120701.png)
...
你可以先看一下下面这张图，有个整体感知，接下来我再具体介绍。
![](img/Pasted%20image%2020240806120855.png)
...
![](img/Pasted%20image%2020240806121602.png)
