# 1 redis对象与编码(底层结构)对应关系引入

在对[对象机制详解](/md/db/nosql-redis/db-redis-x-redis-object.html) 和 [底层数据结构](/md/db/nosql-redis/db-redis-x-redis-ds.html) 有了初步认识之后，我们便可以继续理解它们是怎么对应的：
![](img/Pasted%20image%2020240806091611.png)
...
![](img/Pasted%20image%2020240806091626.png)
...
![](img/Pasted%20image%2020240806091650.png)
...
![](img/Pasted%20image%2020240806091704.png)
...
![](img/Pasted%20image%2020240806091710.png)
...
![](img/Pasted%20image%2020240806091718.png)

当使用 hashtable 编码时，上面命令存储如下：

![](img/Pasted%20image%2020240806091723.png)
...
![](img/Pasted%20image%2020240806091732.png)
...
![](img/Pasted%20image%2020240806091738.png)

```
SADD Dfruits "apple" "banana" "cherry"
```

![](img/Pasted%20image%2020240806091743.png)
...
![](img/Pasted%20image%2020240806091750.png)

然后是编码为SKIPLIST时, 有序集合的内存布局如下:

![](img/Pasted%20image%2020240806091754.png)
...
![](img/Pasted%20image%2020240806091803.png)

![](img/Pasted%20image%2020240806091808.png)
